      ...
      if (ticketId) {
        ...
        setItems(
          ticketItems.map((item: any) => ({
            ...
            tip_customer: ((item.tip_customer_cash || 0) + (item.tip_customer_card || 0)).toString(),
          ...
          <div className="border border-gray-200 rounded-lg p-3 bg-purple-50">
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button
                ...
                className={`flex-1 py-3 md:py-1.5 px-3 text-sm rounded-lg font-medium transition-colors min-h-[48px] md:min-h-0 border-2 ${
