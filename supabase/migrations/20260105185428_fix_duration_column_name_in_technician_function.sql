/*
  # Fix Duration Column Name in Technician Function

  ## Problem
  The get_sorted_technicians_for_store function references `s.estimated_duration_minutes`
  but the correct column name in the services table is `duration_min`.

  ## Solution
  Update the function to use the correct column name `duration_min`.

  ## Changes
  - Fix column reference from estimated_duration_minutes to duration_min
*/
