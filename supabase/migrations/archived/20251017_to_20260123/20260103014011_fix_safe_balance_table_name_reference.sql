/*
  # Fix Safe Balance Table Name Reference
  ...
  1. Changes
    ...
    - Maintains cash_payout for withdrawals and cash_out for deposits
  ...
  3. Impact
    ...
    - Deposits and withdrawals will be calculated properly
*/
