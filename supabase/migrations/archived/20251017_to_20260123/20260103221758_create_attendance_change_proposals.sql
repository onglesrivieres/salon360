...
-- Note: RLS policies are created in the next migration (20260103223408_fix_attendance_proposals_rls_for_pin_auth.sql)
-- which uses the correct PIN-based authentication pattern used by this app.
