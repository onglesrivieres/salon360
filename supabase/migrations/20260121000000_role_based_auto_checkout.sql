/*
  # Role-Based Auto-Checkout Logic

  ## Summary
  Modify the auto-checkout logic so different employee types get checked out at different times:
  - Commission, Daily Technician, Daily Supervisor, Daily Manager: Auto-checkout at last ticket's closing time
  - Daily Receptionist: Auto-checkout at store closing time
  - Others (hourly): Keep existing GREATEST logic

  ## Employee Type Rules
  | Type               | Checkout At         | Definition                                           |
  |--------------------|---------------------|------------------------------------------------------|
  | Commission         | Last ticket closing | pay_type = 'commission'                              |
  | Daily Technician   | Last ticket closing | pay_type = 'daily' AND role contains 'Technician'   |
  | Daily Supervisor   | Last ticket closing | pay_type = 'daily' AND role contains 'Supervisor'   |
  | Daily Manager      | Last ticket closing | pay_type = 'daily' AND role contains 'Manager'      |
  | Daily Receptionist | Store closing       | pay_type = 'daily' AND role contains 'Receptionist' |
*/
